...
CREATE TABLE "categories" ("id" INTEGER GENERATED BY DEFAULT AS IDENTITY NOT NULL, "name" TEXT NOT NULL, "parent" INTEGER, "icon_name" TEXT NOT NULL, "icon_color" TEXT NOT NULL, "icon_background" TEXT NOT NULL, CONSTRAINT "categories_pkey" PRIMARY KEY ("id"), CONSTRAINT "categories_name_unique" UNIQUE ("name"));
...
CREATE TABLE "transactions" ("id" INTEGER GENERATED BY DEFAULT AS IDENTITY NOT NULL, "amount" INTEGER NOT NULL, "currency" INTEGER NOT NULL, "sender" INTEGER, "receiver" INTEGER, "category" INTEGER NOT NULL, "date" date NOT NULL, "note" TEXT NOT NULL, CONSTRAINT "transactions_pkey" PRIMARY KEY ("id"));
