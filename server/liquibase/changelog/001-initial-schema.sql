...
CREATE TABLE "transactions" ("id" INTEGER GENERATED BY DEFAULT AS IDENTITY NOT NULL, "amount" INTEGER NOT NULL, "currency" INTEGER NOT NULL, "sender" INTEGER NOT NULL, "receiver" INTEGER NOT NULL, "category" INTEGER NOT NULL, "date" date NOT NULL, "note" TEXT, CONSTRAINT "transactions_pkey" PRIMARY KEY ("id"));
